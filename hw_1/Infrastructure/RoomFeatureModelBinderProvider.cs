...
{
    public class RoomFeatureModelBinderProvider : IModelBinderProvider
    {
        public IModelBinder GetBinder(ModelBinderProviderContext context)
        {
            ILoggerFactory loggerFactory = context.Services.GetRequiredService<ILoggerFactory>();
            IModelBinder binder = new RoomFeatureModelBinder(new SimpleTypeModelBinder(typeof(DateTime), loggerFactory));
